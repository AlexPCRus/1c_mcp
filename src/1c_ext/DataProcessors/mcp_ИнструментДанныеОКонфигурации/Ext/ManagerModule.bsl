...
Функция СписокМетаданных(Аргументы)
	...
	Для Каждого Элемент Из КоллекцияМД Цикл
		...
		// Создаем структуру с информацией об объекте метаданных
		ОбъектМетаданных = Новый Структура;
		ОбъектМетаданных.Вставить("name", Элемент.Имя);
		ОбъектМетаданных.Вставить("synonym", Элемент.Синоним);
		ОбъектМетаданных.Вставить("fullName", Элемент.ПолноеИмя());
